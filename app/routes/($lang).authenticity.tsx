...
export const meta: MetaFunction = () => {
    return [
        { title: "Authenticity Guarantee | Japan Anime Shoten" },
        { name: "description", content: "Our commitment to 100% authentic anime goods. Learn about our verification process." },
    ];
};
...
export default function AuthenticityPage() {
    ...
    const features = t("authenticity.features", { returnObjects: true }) as Array<{ title: string; desc: string }>;
